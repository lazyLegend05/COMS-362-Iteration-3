...
public class RestockMedicineCommand implements PharmacyCommand {
    private Scanner sc;
    private Pharmacist pharmacist;

    public RestockMedicineCommand(Scanner sc, Pharmacist pharmacist) {
        this.sc = sc;
    ...
    public void execute() {
        ...
        pharmacist.restockMedicine(medicineName, quantity);
    }

    @Override
    public String getName() {
        return "Restock Medicine";
    }
